...
# Input de usuario (se coloca primero el chat_input para que el layout no brinque si no hay historial)
pregunta = st.chat_input("Escribe tu mensaje:")

# Botón para limpiar situado después de renderizar el historial pero antes de procesar el nuevo
