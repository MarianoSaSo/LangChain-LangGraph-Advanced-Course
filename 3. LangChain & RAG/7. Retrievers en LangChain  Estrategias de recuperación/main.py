...
def main():
    print("🔍 Lección 7: Recuperación eficiente con Retrievers en LangChain\n")
    ...
    retriever = vectorstore.as_retriever(
        search_type="similarity",    # Tipo de búsqueda: similitud semántica
        search_kwargs={"k": 2}       # Queremos los 2 fragmentos más relevantes
    )
