...
> **Material del curso:** en esta carpeta encontrarás ejemplos ejecutables (`main.py`) para cada estrategia descrita al final de este artículo. Las lecciones 3 y 4 del tema 5 cubren memoria básica con `MemorySaver` y ventana deslizante con `trim_messages`.
...
**Ejemplo en el repositorio:** `1. Memoria de resumen/main.py` (implementación con LLM real en lugar del placeholder).
...
**Ejemplo en el repositorio:** `2. Memoria de filtrado inteligente/main.py`
...
**Ejemplo en el repositorio:** `3. Memoria por limite de tokens/main.py`
...
**Ejemplo en el repositorio:** `4. Memoria hibrida por tipo de mensaje/main.py`
...
**Ejemplo en el repositorio:** `5. Memoria ventana deslizante adaptativa/main.py`  
*(La ventana deslizante fija con `trim_messages` está en la lección 4 del tema 5.)*
...
**Ejemplo en el repositorio:** `6. Memoria prioridad de contexto/main.py`
...
## Nota para estudiantes (añadido en el curso)

En los `main.py` de esta carpeta aplicamos cada estrategia **justo antes de llamar al LLM** (como en la lección de ventana deslizante): el **checkpointer** (`MemorySaver`) sigue guardando el historial completo de la conversación, pero el modelo solo recibe el subconjunto que define cada técnica. Así podéis comparar comportamientos sin confundir “lo guardado” con “lo que el modelo lee”.

| Carpeta | Estrategia |
|---------|------------|
| `1. Memoria de resumen/` | Resumen + últimos mensajes |
| `2. Memoria de filtrado inteligente/` | Palabras clave / mensajes largos |
| `3. Memoria por limite de tokens/` | Tope estimado de tokens |
| `4. Memoria hibrida por tipo de mensaje/` | Reglas por Human / AI / System |
| `5. Memoria ventana deslizante adaptativa/` | Tamaño de ventana dinámico |
| `6. Memoria prioridad de contexto/` | Keywords del tema actual |
